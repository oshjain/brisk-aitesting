...
| `npm run smoke:contracts` | Pass | 4 coverage counters | 37 runtime exports, 34 type exports, 34 schemas, 20 scripts | 6.0s |
...
| `npm run smoke:adapter-readiness` | Pass | 1 adapter | 1 adapter built and ready | 2.1s |
...
| `npm run pack:check` | Pass | 129 packed files | unpacked size 1,479,825 bytes | 16.6s |
...
| API and contract surface | exported runtime API, type API, schemas, runnable scripts | 37 runtime exports, 34 type exports, 34 schemas, 20 scripts |
...
| Adapter readiness | shipping adapter build | 1 adapter ready |
...
| Package quality | packed publish output | 129 files, 1.48 MB unpacked |
...
| Failed | 0 |
| Pass rate | 100% |
| Report time | `2026-07-28T07:51:44.598Z` |
...
| UI, API, contract, schema, replay, message paths are checked | Yes |
